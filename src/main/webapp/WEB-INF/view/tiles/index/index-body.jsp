<div class="container">
    ...
    <div class="container marketing">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img class="img-circle" src="/static/images/david.jpeg" alt="Deja Vu"
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading" style="color: teal;">Deja Vu <br/><span class="text-muted">Don't get caught repeating yourself.</span>
                </h2>

                <p class="lead">Deja Vu determines common coding patterns and integrates them automatically into your
                    code. You get all the consistency with none of the work.</p>
            </div>
            <div class="col-md-5">
                <img class="featurette-image img-responsive" src="/static/images/valor.jpg"
        ...
        <div class="row featurette">
            <div class="col-md-5">
                <img class="featurette-image img-responsive" src="/static/images/Trustt.jpg"
                     alt="Generic placeholder image">
            </div>
            <div class="col-md-7">
                <h2 class="featurette-heading" style="color: teal;">Trustt Issue Management <br/><span
                        class="text-muted"> Bug tracking software that doesn't bite</span></h2>

                <p class="lead">Tied directly in with your IDE and source control. No more keeping track of bug numbers.
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading" style="color: teal;">Solace Source Control<br/><span class="text-muted"> Every Branch at your fingertips</span>
                </h2>

                <p class="lead">Blah blah blah. Ingegration! Buzz words!</p>
            </div>
            <div class="col-md-5">
                <img class="featurette-image img-responsive" src="/static/images/Solace.jpg"
                     alt="Generic placeholder image">
            </div>
        </div>
